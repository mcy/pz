...
impl TestAll {
  ...
  pub fn new() -> Self {
    ...
    unsafe {
      Self::__raw_init(ptr);
      Self {
        ptr: __rt::__z::ABox::from_ptr(ptr),
        arena,
      }
    }
  }
  ...
  pub fn opt_recursive_or(&self) -> Option<__rt::View<'_, TestAll>> {
    ...
    Some(__rt::View::<TestAll> {
      ptr: unsafe { __rt::__z::ABox::from_ptr(self.ptr.as_ref().opt_recursive) },
      _ph: std::marker::PhantomData,
    })
  }
  ...
  pub fn opt_nested_or(&self) -> Option<__rt::View<'_, TestAll_Nested>> {
    ...
    Some(__rt::View::<TestAll_Nested> {
      ptr: unsafe { __rt::__z::ABox::from_ptr(self.ptr.as_ref().opt_nested) },
      _ph: std::marker::PhantomData,
    })
  }
